...
export const STRINGS = {
  en: {
    ...
    "nav.speed": "⚡ Speed",
    "home.speed": "Speed",
    "home.speedDesc": "Type faster, level by level!",
    "speed.title": "⚡ Speed Levels",
    "speed.sub": "Reach each level's target speed to unlock the next one.",
    "speedtier.beginner": "Beginner",
    "speedtier.amateur": "Amateur",
    ...
    "speed.best": "Best",
    "speed.wpm": "wpm",
    "speed.back": "← All speed levels",
    "speed.accuracy": "Accuracy",
    "speed.locked": "Reach the target on the level before this to unlock it",
    "speed.go": "Type the text below as fast as you can!",
    "speed.yourSpeed": "Your speed",
    "speed.passed": "🎉 You hit the target! Level passed.",
    "speed.tooSlow": "Almost! Reach {target} wpm to pass — keep practicing!",
    "speed.next": "Next level →",
    "speed.retry": "Try again",
  ...
  zh: {
    ...
    "nav.speed": "⚡ 速度",
    "home.speed": "速度",
    "home.speedDesc": "一级一级，打得更快！",
    "speed.title": "⚡ 速度等级",
    "speed.sub": "达到每一级的目标速度，解锁下一级。",
    "speedtier.beginner": "初学者",
    "speedtier.amateur": "业余",
    ...
    "speed.back": "← 所有速度等级",
    "speed.accuracy": "正确率",
    "speed.locked": "先达到上一级的目标才能解锁",
    "speed.go": "尽快打出下面的文字！",
    "speed.yourSpeed": "你的速度",
    "speed.passed": "🎉 你达到了目标！本级通过。",
    "speed.tooSlow": "差一点！达到 {target} 词/分就能通过 — 继续加油！",
    "speed.next": "下一级 →",
    "speed.retry": "再试一次",
  ...
  vi: {
    ...
    "nav.speed": "⚡ Tốc độ",
    "home.speed": "Tốc độ",
    "home.speedDesc": "Gõ nhanh hơn qua từng cấp!",
    "speed.title": "⚡ Cấp độ tốc độ",
    "speed.sub": "Đạt tốc độ mục tiêu của mỗi cấp để mở khóa cấp tiếp theo.",
    "speedtier.beginner": "Người mới",
    "speedtier.amateur": "Tập sự",
    ...
    "speed.best": "Tốt nhất",
    "speed.wpm": "từ/phút",
    "speed.back": "← Tất cả cấp độ tốc độ",
    "speed.accuracy": "Độ chính xác",
    "speed.locked": "Đạt mục tiêu của cấp trước để mở khóa",
    "speed.go": "Gõ đoạn văn bên dưới càng nhanh càng tốt!",
    "speed.yourSpeed": "Tốc độ của bạn",
    "speed.passed": "🎉 Bạn đã đạt mục tiêu! Qua cấp này.",
    "speed.tooSlow": "Sắp rồi! Đạt {target} từ/phút để qua — cứ luyện tập tiếp nhé!",
    "speed.next": "Cấp tiếp theo →",
    "speed.retry": "Thử lại",
